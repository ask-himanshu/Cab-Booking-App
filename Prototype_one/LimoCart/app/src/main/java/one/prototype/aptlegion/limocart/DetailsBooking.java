...
public class DetailsBooking extends AppCompatActivity implements com.google.android.gms.maps.OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_bookings);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent main = new Intent(this,MyBookings.class);
