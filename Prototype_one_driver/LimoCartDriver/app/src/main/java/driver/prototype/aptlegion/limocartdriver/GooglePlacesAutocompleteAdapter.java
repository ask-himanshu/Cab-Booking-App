...
public class GooglePlacesAutocompleteAdapter extends ArrayAdapter implements Filterable {
    ...
    public static ArrayList<String> autocomplete(String input) {
        ...
        try {
            ...
            Log.e("GooglePlacesAutocompleteAdapter", "Error processing Places API URL", e);
            return resultList;
        } catch (IOException e) {
            Log.e("GooglePlacesAutocompleteAdapter", "Error connecting to Places API", e);
            return resultList;
        } finally {
            if (conn != null) {
                conn.disconnect();
        ...
        try {
            ...
            Log.e("GooglePlacesAutocompleteAdapter", "Cannot process JSON results", e);
        }
